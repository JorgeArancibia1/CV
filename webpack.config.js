...
module.exports = {
  ...
  plugins:[
    ...
    new AddAssetHtmlPlugin({
      ...
      publicPath: 'https://JorgeArancibia1.github.io/CV/js' // Desde dónde quiero leer ese archivo(Que lo lea de la carpeta 'js').} // DOMINIO/donde esta el archivo javascript
    }),
